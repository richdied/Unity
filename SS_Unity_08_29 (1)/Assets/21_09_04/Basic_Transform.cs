...
public class Basic_Transform : MonoBehaviour
{
    ...
    void Start() //객체가 생성될때 최초 1번 실행되는 함수.
    {
        ...
        // ㄴ 입력한 x,y,z 회전값을 오브젝트에게 할당해주겠다.
        ...
        //[5] 객체의 크기[Scail]을 스크립트에 제어하는 방법.
        //transform.localScale = new Vector3(3, 3, 1);
        //transform.localScale = Vector
        // ㄴ 입력한 x,y,z 벡터값을 오브젝트의 Scail에 할당해주겠다.
    }
    ...
    void Update() // 1프레임 당 한번씩 호출하는 함수 ( 1프레임 = 평균 0.014초 )
    {
        ...
        //[1] 충돌체 [ Collider ]
        //[2] 강체  [ RigidBody ]
        //[3] 충돌체와 강체를 이용한 점프 구현.
        //[4] GetKeyUp을 활용한 차징점프 구현.
